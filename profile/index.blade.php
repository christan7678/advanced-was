...
<div class="account-page">
    ...
    <section class="account-section account-hero">
        ...
        <div class="account-top">
            ...
            <a href="/login" class="account-signout-btn">Sign Out</a>
        </div>
        ...
        <div class="account-menu">
            ...
            <a href="/address" class="account-menu-item">
                <div>
                    <h3>Address</h3>
            ...
            <a href="/support" class="account-menu-item">
                <div>
                    <h3>Support</h3>
    ...
    <section class="account-section">
        ...
        <div class="account-menu">
            ...
            <a href="/purchase-history" class="account-menu-item">
                <div>
